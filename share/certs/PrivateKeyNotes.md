...
unlocked to sign the Deciphercoin-Qt.app bundle.
...
allowing somebody to distribute a Deciphercoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the deciphercoin-qt.exe file inside the installer had not been tampered with.
