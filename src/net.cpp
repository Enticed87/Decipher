...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("deciphercoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Deciphercoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"bitcoin.petertodd.org", "testnet-seed.deciphercoin.petertodd.org"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Deciphercoin is probably already running."), addrBind.ToString().c_str());
        else
